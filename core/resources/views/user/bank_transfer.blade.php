        ...
        <div class="card">
          ...
          @csrf
           <div class="form-group row">
              ...
              <div class="col-lg-10">
                <div class="input-group">
                  <span class="input-group-prepend">
                    <span class="input-group-text">{{$currency->method}}</span>
                  </span>

                <input readonly type="text" step="any" name="method" value="{{$bank->bank_name}}" class="form-control">
                  </div>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              <label class="col-form-label col-lg-2">Receipt details</label>
              <div class="col-lg-10">
                  <textarea type="text" class="form-control" rows="3" placeholder="" name="details" required></textarea>
              </div>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-lg-2">Picture Of Receipt</label>
              <div class="col-lg-10">
                <div class="input-group">
