  ...
  <div class="container-fluid d-flex align-items-center">
    <div class="row">
      ...
      <div class="col-lg-6 col-12 text-right">
          <a href="{{url('/')}}/user/fund#other" class="btn btn-sm btn-neutral">Fund deposit logs</a>
...
<div class="container-fluid mt--6">
  <div class="content-wrapper">
    <div class="row">
      ...
      @foreach($adminbank as $adminbank)
       <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col-auto">
                  <a href="{{route('user.' . $adminbank->link)}}" class="avatar avatar-xl">
                    <img alt="Image placeholder" src="{{url('/')}}/asset/payment_gateways/{{$adminbank->bank_name}}.png">
                  </a>
                </div>
                <div class="col ml--2">
                  <h4 class="mb-0">
                  ...
                  <p class="text-sm text-muted mb-0">{{$adminbank->address}}</p>
                  <p class="text-sm text-muted mb-0">Account number: <h5>{{$adminbank->acct_no}}</h5></p>
                </div>
              </div>
            </div>
          </div>
