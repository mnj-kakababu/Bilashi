    ...
    Route::post('postEmailVerify', 'UserController@postEmailVerify')->name('user.email-verify');
        Route::group(['middleware'=>'isActive'], function() {
            Route::middleware(['CheckStatus'])->group(function () {
                ...
                Route::get('bkash_transfer', 'UserController@bkash_transfer')->name('user.bkash_transfer');
                Route::get('nogod_transfer', 'UserController@nogod_transfer')->name('user.nogod_transfer');
