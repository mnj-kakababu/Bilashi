...
class UserController extends Controller
{
    ...
    public function loan()
    {
        ...
        $data['loan']=Loan::whereUser_id(Auth::user()->id)->latest('updated_at')->get();
    ...
    public function fund()
    {
        ...
        $data['adminbank']=Adminbank::whereStatus(1)->orderBy('id')->get();
    ...
    public function bkash_transfer()
    {
        $data['title']='Bank transfer';
        $data['bank']=Adminbank::whereId(2)->first();
        return view('user.bank_transfer', $data);
    }
    public function nogod_transfer()
    {
        $data['title']='Bank transfer';
        $data['bank']=Adminbank::whereId(3)->first();
        return view('user.bank_transfer', $data);
    }
